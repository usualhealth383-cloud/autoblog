...
| 디자인(v3.1, 2026-09-08) | 브랜드 딥틸로 앱 껍데기 통일(단원 색은 그 단원 화면 안에서만) · 시작/로그인/회원가입 재설계 · 오늘 개념 ①②③ 세로 배치 · 손가락 목표 40px 이상 · 다크 모드 확인 |
| 앱 기능(v4, 2026-09-08) | **오늘의 한 마디**(출처 검증 글귀 39개 + 그날 단원으로 잇는 한 줄, 보관함) · **일정**(학원·학교·과외 시간표, D-day, 시험 범위에서 바로 문제 풀기, 학원 발신 일정) · **이야기**(질문·자료 공유·응원 게시판, 댓글·채택·도움됨, 개념 첨부, 닉네임·개인정보 감지·신고·원장 관리) |
